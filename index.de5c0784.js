...
const loadSearchResults = async function() {
    try {
        ...
        const data = await getJSON(`${API_URL}track.search?q_track_artist=${encodeURIComponent(query)}&page_size=7&page=1&apikey=${apiKey}&s_track_rating=DESC
      `);
        ...
        const resultMarkup = state.search.results.map((track)=>`
      <li class="preview">
