const e="https://api.musixmatch.com/ws/1.1/",t=secrets.MUSIX_API_KEY,a=secrets.GENIUS_API_KEY,s=document.querySelector(".search"),r=document.querySelector(".search__field"),i=document.querySelector(".results"),n=document.querySelector(".music"),c=document.getElementsByTagName("head")[0],l=document.querySelector(".pagination"),o=document.querySelector(".modal"),m=document.querySelector(".nav__btn--about-us"),d=document.querySelector(".modal__btn-close");console.log(t);let u={search:{query:"",results:[],resultsView:[],perPage:10,page:1}};addEventListener("fetch",e=>{e.respondWith(handleRequest(e.request))});const g=async function(e){try{let t=await fetch(e),a=await t.json();if(0===a.message.body.length)throw Error(`Status Code: ${a.message.header.status_code}`);if(0===a.message.header.available)throw Error("Not found Any Track!");return a}catch(e){throw e}},p=function(){let e=r.value;return r.value="",e},_=function(e){let t=`
...
//# sourceMappingURL=index.08f75536.js.map
